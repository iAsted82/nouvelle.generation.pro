          ...
          <div className="space-y-6 animate-fadeInUp">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Une école maternelle moderne avec enseignement trilingue (français, arabe, anglais) et pédagogie innovante. Classes limitées à 15 élèves dans un environnement bienveillant et stimulant.
              </p>
            </div>
              ...
              <div className="bg-white rounded-3xl shadow-2xl p-8 transform rotate-3 hover:rotate-0 transition-transform duration-500">
                <div className="space-y-6">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600">Enseignement trilingue - Pédagogie innovante</p>
                  </div>
