...
import { currencyService, CURRENCIES, Currency } from '../services/currencyService';
...
const CurrencySelector: React.FC<CurrencySelectorProps> = ({ variant = 'default' }) => {
  ...
  const currentConfig = CURRENCIES.find(curr => curr.code === currentCurrency) || CURRENCIES[0];
    ...
    <div className="relative">
      ...
      >
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm font-medium text-gray-700">{currentConfig.code}</span>
        </div>
